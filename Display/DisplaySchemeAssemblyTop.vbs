...
If pcbAppObj.LockServer = True Then
    ...
    For i = 2 To conductorLayerCount
		displayCtrlObj.Visible( "LayerControl." & i ) = epcbGraphicsItemStateOffEnabled	
	Next
    With displayCtrlObj
        .Visible( "Copper.Trace.1" ) = epcbGraphicsItemStateOnEnabled
        .Visible( "Copper.Pad.1" ) = epcbGraphicsItemStateOnEnabled
        .Visible( "Copper.Plane.Data.1" ) = epcbGraphicsItemStateOnEnabled
        .Global.Color( "Copper.Trace.1" ) = utilityObj.NewColorPattern( 255, 0, 0, 100, 0, False, True ) 
        .Global.Color( "Copper.Pad.1" ) = utilityObj.NewColorPattern( 192, 192, 192, 100, 0, False, True ) 
        .Global.Color( "Copper.Plane.Data.1" ) = utilityObj.NewColorPattern( 255, 0, 0, 100, 0, False, True ) 
	    .Visible( "LayerControl.1" ) = epcbGraphicsItemStateOnEnabled
	...
	With displayCtrlObj
        ...
        ' Place
			...
			.Option( "Option.PlaceObjects.ObstructsAndRooms.Bottom" ) = epcbGraphicsItemStateOffEnabled 
				...
				.Option( "Option.Pin.Number.Bottom" ) = epcbGraphicsItemStateOffEnabled 
			...
			.Option( "Option.PlaceObjects.PartItems.Bottom" ) = epcbGraphicsItemStateOffEnabled 
        .Option( "Option.PlaceObjects.Parts.Top" ) = epcbGraphicsItemStateOnEnabled 
        .Option( "Option.PlaceObjects.Parts.Bottom" ) = epcbGraphicsItemStateOffEnabled 
        ...
        ' Board Objects
                ...
                .Visible( "Copper.Pad.Fiducial.Bottom" ) = epcbGraphicsItemStateOffEnabled 
            .Option( "Option.Fiducials.Enabled" ) = epcbGraphicsItemStateOnEnabled 
        ...
        .Option( "Option.BoardObjects.Enabled" ) = epcbGraphicsItemStateOnEnabled 
        '.Lock
        .Global.Color( "Copper.Pad.Fiducial.Top" ) = utilityObj.NewColorPattern( 204, 153, 0, 100, 0, False, True ) 
		...
		.Visible( "Fabrication.SolderMask.Top" ) = epcbGraphicsItemStateOnEnabled 
        ...
        .Option( "Option.Fabrication.AssemblyItems.Bottom" ) = epcbGraphicsItemStateOffEnabled  
        ...
        ' .Lock
        .Global.Color( "Fabrication.Soldermask.Top" ) = utilityObj.NewColorPattern( 204, 153, 0, 100, 0, False, True ) 
        .Global.Color( "Fabrication.Assembly.Part.Outline.Top" ) = utilityObj.NewColorPattern( 119, 119, 119, 100, 0, False, True ) 
        .Global.Color( "Fabrication.Silkscreen.Part.Outline.Top" ) = utilityObj.NewColorPattern( 0, 0, 0, 100, 0, False, True ) 
        .Global.Color( "Fabrication.Silkscreen.Part.Text.RefDes.Top" ) = utilityObj.NewColorPattern( 0, 0, 0, 100, 0, False, True ) 
        .Global.Color( "Fabrication.Silkscreen.TestPoint.Text.RefDes.Top" ) = utilityObj.NewColorPattern( 0, 0, 0, 100, 0, False, True ) 
        ' .Unlock
    ...
    ' displayCtrlObj.SaveSchemeEx("Sys:MyAssemblyTop")
